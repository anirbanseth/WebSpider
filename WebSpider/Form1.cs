...
namespace WebSpider
{
    public partial class Form1 : Form
    {
        ...
        private void buttonGo_Click(object sender, EventArgs e)
        {
            ...
            //Dictionary<string, object> temp = JsonConvert.DeserializeObject<Dictionary<string, object>>(response);
            ...
            Thread thread = new Thread(new ThreadStart(LoadCategory));
            thread.Start();
            #endregion
